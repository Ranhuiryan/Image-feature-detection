...
public:
    ...
    // Calculate Texture Eigenvalues of One Window Mat, which is including Energy, Contrast, Correlation, Entropy.
    ...
    // 计算整幅图像的纹理特征
    void CalcuTextureImages(Mat src, Mat& imgEnergy, Mat& imgContrast, Mat& imgCorrelation, Mat& imgEntropy, Mat& imgidMoment,
